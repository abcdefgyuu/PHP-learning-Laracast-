  ...
  <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
    <form method="POST" action="/note">
      ...
      <div class="mt-6 flex items-center justify-end gap-x-6 w-1/2 m-auto">
        <a href="/notes" class="rounded-md bg-gray-400 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-gray-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Cancel</a>
