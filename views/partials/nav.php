       ...
       <div class="flex items-center">
         ...
         <div class="hidden md:block">
           <div class="ml-10 flex items-baseline space-x-4">
             ...
             <a href="about.php" class="<?= urlIs('/learning/about.php') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">About Us</a>
             <a href="contact.php" class="<?= urlIs('/learning/contact.php') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Contact</a>
           </div>
         </div>
       </div>
       <div class="hidden md:block">
