       ...
       <div class="flex items-center">
         ...
         <div class="hidden md:block">
           <div class="ml-10 flex items-baseline space-x-4">
             ...
             <a href="/learning/index.php" aria-current="page" class="<?= urlIs('/learning/index.php') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
             <a href="/learning/about" class="<?= urlIs('/learning/about') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">About Us</a>
             <a href="/learning/notes" class="<?= urlIs('/learning/notes') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Notes</a>
             <a href="/learning/contact" class="<?= urlIs('/learning/contact') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium hover:bg-white/5 hover:text-white">Contact</a>
           </div>
         </div>
       </div>
       <div class="hidden md:block">
