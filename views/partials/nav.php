       ...
       <div class="flex items-center">
         ...
         <div class="hidden md:block">
           <div class="ml-10 flex items-baseline space-x-4">
             ...
             <a href="index.php" aria-current="page" class="<?= urlIs('/learning/index.php') ? 'bg-slate-300 text-gray-900' : 'text-gray-300';?> rounded-md px-3 py-2 text-sm font-medium">Home</a>
